...
export default class InputLock {
  ...
  filter() {
    ...
    if (
      this.inputs.includes(115) ||
      this.inputs.includes(116) ||
      this.inputs.includes(123) ||
      (this.inputs.includes(17) && this.inputs.includes(83)) ||
      (this.inputs.includes(17) &&
        this.inputs.includes(16) &&
        this.inputs.includes(77)) ||
      (this.inputs.includes(17) &&
        this.inputs.includes(16) &&
        this.inputs.includes(67)) ||
      (this.inputs.includes(17) &&
        this.inputs.includes(16) &&
        this.inputs.includes(83)) ||
      (this.inputs.includes(17) &&
        this.inputs.includes(16) &&
        this.inputs.includes(73))
    ) {
      res = true;
    }
